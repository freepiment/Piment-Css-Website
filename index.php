...
<main>
    ...
    <div class="main-intro container max-width-xl">
        <div class="flex-column text-center">
            <h1>Piment <sup>&reg;</sup></h1>
            <p class="p">Piment is a micro CSS framework<br>for faster and easier web development.</p>
    ...
    <div class="main-content bg-blue mt-3">
        <div class="flex-column max-width-xl p-2">
            <h2>Introducing Piment
                <svg viewBox="0 0 100 55" width="50">
                    ...
                    <path fill="#53AF32" stroke="#53AF32" stroke-width="2.1423" stroke-linecap="round"
                          stroke-linejoin="round" d="M84.43,19.55l0.46,1.36l0.66,1.47l0.66,1.28l0.77,0.96l0.93,0.68"></path>
            ...
            <p>Need reasons to love Piment? 🥵 Look no further. </p>

            <div class="columns">
                <div class="col">
                    <div class="box">
                        <figure>
                            <img src="assets/img/undraw_engineering.svg" alt="Piment CSS nerds">
                        </figure>
                        <h3>By nerds, for nerds.</h3>
                        <p>Built by Webmonster (MQ) by Xavier, <strong>Piment</strong> utilizes SASS, is compiled via Node to help nerds do awesome stuff on the web.</p>
                    </div>
                </div>
                <div class="col">
                    <div class="box">
                        <figure>
                            <img src="assets/img/undraw_conversation.svg" alt="Piment CSS for everyone">
                        </figure>
                        <h3>Made for everyone.</h3>
                        <p>Piment was made to not only look and behave great in the latest desktop browsers, but in tablet and smartphone browsers via responsive CSS as well.</p>
                    </div>
                </div>
                <div class="col">
                    <div class="box">
                        <figure>
                            <img src="assets/img/undraw_prototyping.svg" alt="Piment CSS nerds">
                        </figure>
                        <h3>Packed with features.</h3>
                        <p>A 12-column responsive grid, dozens of components, typography, form controls, and more...</p>
                    </div>
                </div>
            </div>
        </div>
